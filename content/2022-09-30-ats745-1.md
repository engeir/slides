...
from CSM, and we remember that CCSM2 was released in 2002, while CSM was released in 1996. (A long time ago!)
...
Vertical velocity in CAM6 come from vertical pressure velocity. (See
[wn](https://github.com/ESCOMP/CAM/blob/cam_cesm2_2_rel/src/ionosphere/waccmx/dpie_coupling.F90#L307)
and
[omega](https://github.com/ESCOMP/CAM/blob/cam_cesm2_2_rel/src/physics/cam/cldwat.F90#L259).)
...
arbitrarily long time steps, but also damping. Dynamics and physics are "time split" in
the sense that all prognostic variables are updated sequentially by the "dynamics" and
then the "physics".
...
There are 60 levels that go down to a depth of $5000\\,\mathrm{m}$. The resolution is
$10\\,\mathrm{m}$ down to $160\\,\mathrm{m}$, then it increases monotonically to
$250\\,\mathrm{m}$ at $3500\\,\mathrm{m}$.
